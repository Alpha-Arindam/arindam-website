...
### Decorative Depth
- **Decorative depth**: No gradients, no shadows on chrome.
...
| Tablet portrait | 736–833px | Global nav collapses to hamburger; sub-nav collapses to category name + primary CTA |
...
- Hero photography may switch art direction at mobile (e.g., the environment page's vista crops to a larger aspect ratio on mobile, framing the subject differently).
